...
pub fn curated_cases() -> Vec<ParityFixtureCase> {
    vec![
        ...
        ParityFixtureCase {
            path: "examples/type_system/162_effect_row_order_equivalence_ok.flx",
            roots: &[],
            strict: false,
            expect_compile_error: false,
            category: "C",
        ...
        ParityFixtureCase {
            path: "examples/type_system/163_effect_row_subtract_concrete_ok.flx",
            roots: &[],
            strict: false,
            expect_compile_error: false,
            category: "C",
        ...
        ParityFixtureCase {
            path: "examples/type_system/164_effect_row_subtract_var_satisfied_ok.flx",
            roots: &[],
            strict: false,
            expect_compile_error: false,
            category: "C",
        ...
        ParityFixtureCase {
            path: "examples/type_system/165_effect_row_multivar_disambiguated_ok.flx",
            roots: &[],
            strict: false,
            expect_compile_error: false,
            category: "C",
        ...
        ParityFixtureCase {
            path: "examples/type_system/166_effect_row_absent_ordering_linked_ok.flx",
            roots: &[],
            strict: false,
            expect_compile_error: false,
            category: "C",
