...
fn builtin_primop_table() -> HashMap<(&'static str, usize), CorePrimOp> {
    let entries: &[(&str, usize, CorePrimOp)] = &[
        ...
        ("try_read_file", 1, CorePrimOp::TryReadFile),
        ("fs_exists", 1, CorePrimOp::FsExists),
        ("fs_is_dir", 1, CorePrimOp::FsIsDir),
        ("fs_is_file", 1, CorePrimOp::FsIsFile),
        ("fs_write_file", 2, CorePrimOp::FsWriteFile),
        ("fs_create_dir_all", 1, CorePrimOp::FsCreateDirAll),
        ("fs_remove_file", 1, CorePrimOp::FsRemoveFile),
        ("fs_remove_dir_all", 1, CorePrimOp::FsRemoveDirAll),
        ("fs_rename", 2, CorePrimOp::FsRename),
        ("fs_list_dir", 1, CorePrimOp::FsListDir),
        ("fs_metadata", 1, CorePrimOp::FsMetadata),
        ("sha256", 1, CorePrimOp::Sha256),
        ("sha256_file", 1, CorePrimOp::Sha256File),
