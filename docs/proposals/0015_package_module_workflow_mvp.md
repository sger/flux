...
- Status: Superseded by [0177_package_manager.md](implemented/0177_package_manager.md)
- Proposal PR: 
- Flux Issue: 
...
> The complete design lives in [0177_package_manager.md](implemented/0177_package_manager.md),
