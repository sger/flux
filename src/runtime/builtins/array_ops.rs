...
pub(super) fn builtin_any(ctx: &mut dyn RuntimeContext, args: Vec<Value>) -> Result<Value, String> {
...
/// Works on Arrays and Lists
pub(super) fn builtin_all(ctx: &mut dyn RuntimeContext, args: Vec<Value>) -> Result<Value, String> {
