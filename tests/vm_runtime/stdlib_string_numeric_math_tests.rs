//! Integration driver for the `tests/flux/stdlib_string_numeric_math.flx` fixture.
//!
...
#[test]
fn stdlib_string_numeric_math_fixture_passes_on_the_vm() {
    assert_fixture_passes("stdlib_string_numeric_math.flx");
}
