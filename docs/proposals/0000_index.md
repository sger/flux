...
| 0169 | [0169_parameterized_handlers.md](0169_parameterized_handlers.md) | Draft | gap | new (2026-04-22) | parameterized effect handlers (`handle Eff(init) { arm(resume, …, state) → … }`) to express State/Reader/Counter without mutable bindings; threads state through each resume; enables 0162 Phase 2 shape-matching |
