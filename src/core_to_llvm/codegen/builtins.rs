...
static BUILTIN_MAPPINGS: &[BuiltinMapping] = &[
    ...
    BuiltinMapping { flux_name: "get",         c_name: "flux_hamt_get_option", arity: 2, returns_value: true },
    ...
    // Collection helpers
    BuiltinMapping { flux_name: "first",       c_name: "flux_first",           arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "keys",        c_name: "flux_hamt_keys",       arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "split",       c_name: "flux_split",           arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "to_list",     c_name: "flux_to_list",         arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_array",    c_name: "flux_is_array",        arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_map",      c_name: "flux_is_map",          arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_hash",    c_name: "flux_is_map",          arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "last",       c_name: "flux_last",            arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "rest",       c_name: "flux_rest",            arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "tl",         c_name: "flux_rest",            arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "values",     c_name: "flux_hamt_values",     arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "hd",         c_name: "flux_first",           arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "len",        c_name: "flux_rt_len",          arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "length",     c_name: "flux_rt_len",          arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "size",       c_name: "flux_hamt_size",       arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "contains",   c_name: "flux_array_contains",  arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "push",       c_name: "flux_array_push",      arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "reverse",    c_name: "flux_array_reverse",   arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "concat",     c_name: "flux_array_concat",    arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "trim",       c_name: "flux_trim",            arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "join",       c_name: "flux_join",            arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "parse_int",  c_name: "flux_parse_int",       arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "int_to_string", c_name: "flux_int_to_string", arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_list",    c_name: "flux_is_list",         arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_some",    c_name: "flux_is_some",         arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "is_none",    c_name: "flux_is_none",         arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "merge",      c_name: "flux_hamt_merge",      arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "unwrap",     c_name: "flux_unwrap",          arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "unwrap_or",  c_name: "flux_unwrap_or",       arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "to_array",   c_name: "flux_to_array",        arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "type_of",    c_name: "flux_type_of",         arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "abs",        c_name: "flux_abs",             arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "min",        c_name: "flux_min",             arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "max",        c_name: "flux_max",             arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "array_len",  c_name: "flux_array_len",       arity: 1, returns_value: true },
    BuiltinMapping { flux_name: "array_push", c_name: "flux_array_push",      arity: 2, returns_value: true },
    BuiltinMapping { flux_name: "array_set",  c_name: "flux_array_set",       arity: 3, returns_value: true },
