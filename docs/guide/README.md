...
21. [Type Classes](21_type_classes.md) — `class` / `instance`, constrained functions and dictionaries, the standard hierarchy in `lib/Flow/`, superclasses, contextual instances, result-directed dispatch, `deriving`
