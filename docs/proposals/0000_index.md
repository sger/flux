...
| 0107 | [0107_general_tail_call_elimination.md](0107_general_tail_call_elimination.md) | Draft | gap | proposal-only | general TCE for mutual recursion, indirect/closure tail calls, and CPS; extends 0016 self-recursive TCO |
| 0108 | [0108_base_function_effect_audit.md](0108_base_function_effect_audit.md) | Draft | gap | proposal-only | systematic audit of 77 base function effect annotations; prerequisite for 0099 IO migration |
...
| 0131 | [0131_primop_effect_levels.md](0131_primop_effect_levels.md) | Draft | gap | proposal-only | three-level `Pure/CanFail/HasEffect` taxonomy; current is binary `is_pure` |
...
| 0141 | [0141_unified_effect_handlers.md](0141_unified_effect_handlers.md) | Draft | gap | proposal-only | yield-based Koka-style unified handler model; VM and native retain incompatible implementations |
| 0143 | [0143_actor_concurrency_roadmap.md](0143_actor_concurrency_roadmap.md) | Draft | gap | proposal-only | canonical Aether-aware actor concurrency roadmap; supersedes 0026/0065/0066/0067/0071/0095 |
| 0151 | [0151_module_scoped_type_classes.md](0151_module_scoped_type_classes.md) | Partially Implemented | partial | Phase 1 Step 1 (module-body validator accepts `class`/`instance`/`import`) landed; end-to-end semantics open | continue Phase 1a/1b |
...
| 0029 | [0029_base_and_flow.md](superseded/0029_base_and_flow.md) | Superseded | [0028_base.md](implemented/0028_base.md), [0030_flow.md](0030_flow.md) | keep for history with supersession banner |
