...
pub const ERROR_CODES: &[ErrorCode] = &[
    ...
    SUPERCLASS_CYCLE,
    STALE_CLASS_INTERFACE,
    DUPLICATE_ASSOCIATED_TYPE,
    MISSING_ASSOCIATED_TYPE,
    UNBOUND_ASSOCIATED_TYPE_VARIABLE,
    ASSOCIATED_TYPE_KIND_MISMATCH,
    RECURSIVE_ASSOCIATED_TYPE,
    UNKNOWN_ASSOCIATED_TYPE,
    AMBIGUOUS_DICTIONARY_SELECTION,
    UNDERIVABLE_CLASS,
    OPERATOR_CLASS_NOT_IN_SCOPE,
    INSTANCE_SEARCH_EXHAUSTED,
    COULD_NOT_DEDUCE,
    UNRESOLVED_FIELD_RECEIVER,
    UNRESOLVED_TUPLE_RECEIVER,
