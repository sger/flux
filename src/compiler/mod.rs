...
impl Compiler {
    ...
    fn register_cost_centre(&mut self, name: &str, module: &str) -> u16 {
        ...
        self.cost_centre_infos
            .push(crate::bytecode::debug_info::CostCentreInfo {
                name: name.to_string(),
    ...
    ) -> Option<crate::compiler::effect_rows::EffectRow> {
        use crate::compiler::effect_rows::EffectRow;
    ...
    pub(super) fn convert_const_compile_error(
        &self,
        err: module_constants::ConstCompileError,
        position: Position,
    ) -> Diagnostic {
        match err {
            module_constants::ConstCompileError::CircularDependency(cycle) => {
            ...
            module_constants::ConstCompileError::EvalError {
                position: pos,
                error,
                ..
            } => {
