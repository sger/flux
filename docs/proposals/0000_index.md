...
| 0165 | [0165_io_primop_migration_to_effect_handlers.md](0165_io_primop_migration_to_effect_handlers.md) | Blocked | gap | spike completed 2026-04-23; 0170 is now implemented, remaining blockers are 0161 + 0162 Phase 1 | Route `println`/`print`/`read_file`/etc. through `Perform`; synthesize default handlers around `main`/`test_*` |
