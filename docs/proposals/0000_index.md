...
| 0161 | [0161_effect_system_decomposition_and_capabilities.md](0161_effect_system_decomposition_and_capabilities.md) | Partial | partial | refreshed 2026-04-23: compiler-seeded decomposition, strict `Flow` audit slice, and shared compiler/Aether Phase 3 registry cleanup | sealing and `Flow.Primops` remain deferred; supersedes 0075, 0108, 0131 |
