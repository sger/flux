...
fn lower_core_top_level_item(item: &CoreTopLevelItem) -> IrTopLevelItem {
    match item {
        ...
        CoreTopLevelItem::Class { name, type_params, superclasses, methods, span } => IrTopLevelItem::Class {
            name: *name,
            type_params: type_params.clone(),
        ...
        CoreTopLevelItem::Instance { class_name, type_args, context, methods, span } => IrTopLevelItem::Instance {
