...
use crate::{
    ...
    compiler::symbol_scope::SymbolScope,
...
impl Compiler {
    ...
    pub(super) fn try_compile_ir_cfg_function_body(
        ...
        let mut bindings: HashMap<IrVar, crate::compiler::binding::Binding> = HashMap::new();
    ...
    fn compile_ir_cfg_instr(
        &mut self,
        instr: &IrInstr,
        bindings: &HashMap<IrVar, crate::compiler::binding::Binding>,
        current_name: Symbol,
    ) -> CompileResult<()> {
            ...
            IrInstr::AetherDrop { var, .. } => {
                ...
                if let Some(binding) = bindings.get(var) {
                    match binding.symbol_scope {
                        crate::compiler::symbol_scope::SymbolScope::Local => {
