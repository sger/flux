...
pub(super) fn builtin_len(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_first(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_last(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_rest(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_push(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_concat(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_reverse(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_contains(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_slice(args: Vec<Object>) -> Result<Object, String> {
...
pub(super) fn builtin_sort(args: Vec<Object>) -> Result<Object, String> {
