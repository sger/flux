...
- unification still treats `Any` as compatible with everything in [unify.rs](src/types/unify.rs:21)
- strict typing is implemented as a post-inference binding check in [strict_types.rs](src/ast/type_infer/strict_types.rs:1)
- many HM inference paths still return `Any` on unsupported or mixed cases
- runtime type lowering still collapses unresolved/high-level forms to `RuntimeType::Any` in [type_env.rs](src/types/type_env.rs:354)
...
- **0149 operator desugaring** — implemented
  - [0149_operator_desugaring.md](docs/proposals/implemented/0149_operator_desugaring.md:1)
- **0150 HKT instance resolution** — complete
  - [0150_hkt_instance_resolution.md](docs/proposals/0150_hkt_instance_resolution.md:1)
- **0074 base HM signature tightening** — implemented
  - [0074_base_signature_tightening.md](docs/proposals/implemented/0074_base_signature_tightening.md:1)
- **typed Core/Aether/native pipeline work** — largely implemented
  - [0123_full_static_typing.md](docs/proposals/implemented/0123_full_static_typing.md:1)
...
- **0147 instance context enforcement and constrained type parameter completion**
  - [0147_constrained_type_params_and_instance_contexts.md](docs/proposals/0147_constrained_type_params_and_instance_contexts.md:1)
...
- ADT inference fallbacks:
  - [adt.rs](src/ast/type_infer/adt.rs:113)
- collection inference:
  - [collections.rs](src/ast/type_infer/expression/collections.rs:52)
- operator inference:
  - [operators.rs](src/ast/type_infer/expression/operators.rs:22)
- effect inference:
  - [effects_nodes.rs](src/ast/type_infer/expression/effects_nodes.rs:22)
- access/member/index inference:
  - [access.rs](src/ast/type_infer/expression/access.rs:23)
  - [access.rs](src/ast/type_infer/expression/access.rs:84)
- control-flow joins:
  - [unification.rs](src/ast/type_infer/unification.rs:77)
- generic expression fallback:
  - [expression/mod.rs](src/ast/type_infer/expression/mod.rs:61)
...
This phase must also change the foundational rule in [unify.rs](src/types/unify.rs:101):
...
- [strict_types.rs](src/ast/type_infer/strict_types.rs:1)
...
See:
- [type_env.rs](src/types/type_env.rs:354)
- [type_env.rs](src/types/type_env.rs:399)
...
- `InferType::Con(TypeConstructor::Any)` is still first-class in:
  - [infer_type.rs](src/types/infer_type.rs:257)
- `contains_any()` is still a core utility:
  - [infer_type.rs](src/types/infer_type.rs:272)
...
- [strict_types.rs](src/ast/type_infer/strict_types.rs:17)
...
- [0123_full_static_typing.md](docs/proposals/implemented/0123_full_static_typing.md:1) says “all phases complete”
