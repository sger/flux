...
// GC heap tests removed in Aether Phase 4 — Value::Gc variant no longer exists.
// The GcHeap struct is retained as a stub for API compatibility.
// GC heap unit tests removed in Aether Phase 4 (Value::Gc no longer exists).
