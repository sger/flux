...
- **Detailed specification (migrated legacy content):** > Historical combined context document. > Canonical current split: > - Base: `docs/proposals/0028_base.md` > - Flow: `docs/proposals/0030_flow.md`
