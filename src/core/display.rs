...
fn write_primop_name(out: &mut String, op: &CorePrimOp, _interner: &Interner) {
    match op {
        ...
        CorePrimOp::FsExists => out.push_str("FsExists"),
        CorePrimOp::FsIsDir => out.push_str("FsIsDir"),
        CorePrimOp::FsIsFile => out.push_str("FsIsFile"),
        CorePrimOp::FsCreateDirAll => out.push_str("FsCreateDirAll"),
        CorePrimOp::FsRemoveFile => out.push_str("FsRemoveFile"),
        ...
        CorePrimOp::EnvVar => out.push_str("EnvVar"),
        ...
        CorePrimOp::FiberTimeout => out.push_str("FiberTimeout"),
        CorePrimOp::FiberNewScope => out.push_str("FiberNewScope"),
        CorePrimOp::FiberForkScoped => out.push_str("FiberForkScoped"),
        CorePrimOp::FiberCancelScope => out.push_str("FiberCancelScope"),
        ...
        CorePrimOp::ChanCap => out.push_str("ChanCap"),
        ...
        CorePrimOp::EventChoose => out.push_str("EventChoose"),
