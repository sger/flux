...
| 0177 | [0177_package_manager.md](0177_package_manager.md) | Partially implemented | partial | Phases 0–1 shipped 2026-08-24; supersedes 0015 | Package manager: `flux.toml`, `flux.lock`, namespaced packages, registry + store. Phase 0 (`lib/Flume/*`: TOML parser, manifest schema, version arithmetic, resolver) and Phase 1 (`flux init/new/build/run/test/check`, path dependencies, namespace-scoped module roots, E469–E471) are live; flux now works outside its own checkout. Phases 2–3 (registry, lockfile, store) not started |
