...
These address the remaining 50ms → 3ms gap to GHC. Each is a significant project and would warrant its own proposal. Documented here as the roadmap based on GHC source analysis (`ghc`).
