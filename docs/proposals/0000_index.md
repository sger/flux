...
| 0127 | [0127_type_inference_ghc_parity.md](0127_type_inference_ghc_parity.md) | Draft | partial | constraints/solver/elaboration/kinds are landed; remaining inference gaps are narrower and concrete execution is split into `0159` plus closure criteria in `0160` | keep as the inference follow-on roadmap |
| 0145 | [0145_type_classes.md](0145_type_classes.md) | In Progress | partial | type classes, solver, elaboration, hardening, and HKTs are largely landed; a few follow-ons remain | keep as constrained-polymorphism authority |
| 0155 | [0155_core_ir_parity_simplification.md](0155_core_ir_parity_simplification.md) | Draft | gap | proposal-owned `core_lint` and related Core validation work are not yet landed | keep as the implementation-owning Core validation proposal |
| 0156 | [0156_static_typing_completion_roadmap.md](0156_static_typing_completion_roadmap.md) | Draft | have | maintained front-end static typing is complete and documented here | keep as authoritative static-typing completion proposal |
| 0157 | [0157_explicit_core_types_and_runtime_representation_split.md](0157_explicit_core_types_and_runtime_representation_split.md) | Draft | partial | architecture rationale reflected by landed downstream cleanup work | keep as rationale for semantic-vs-representation split |
| 0158 | [0158_core_semantic_types_and_backend_rep_split_execution.md](0158_core_semantic_types_and_backend_rep_split_execution.md) | Implemented | have | explicit Core semantic residue + rep-oriented CFG/LIR cleanup landed in maintained paths | keep as downstream execution closure |
| 0159 | [0159_signature_directed_checking_and_skolemisation.md](0159_signature_directed_checking_and_skolemisation.md) | Delivered | have | bidirectional check mode, rigid skolem variables (E305), recursive pre-binding, and call-site lambda propagation landed 2026-04-17 | see `docs/internals/proposal_0159_investigation.md` for predeclaration collapse pin-down |
| 0160 | [0160_static_typing_hardening_closure.md](0160_static_typing_hardening_closure.md) | Draft | gap | umbrella closure proposal for scheme normalization plus final `0155` / `0159` acceptance criteria | keep as the static-typing hardening closure umbrella |
