...
| 0083 | [0083_typed_holes.md](implemented/0083_typed_holes.md) | Implemented | have | shipped v0.0.6: `?name` expression holes report expected type + candidate fits ([changes/2026-06-02-typed-holes.md](../../changes/2026-06-02-typed-holes.md)) | closed 2026-07-09 (0177 T5.1 status sweep) |
...
| 0152 | [0152_named_fields_for_data_types.md](implemented/0152_named_fields_for_data_types.md) | Implemented | have | shipped v0.0.6: named fields + dot-access + functional update (`src/ast/desugar_named_fields.rs`, [docs/guide/16_named_fields.md](../guide/16_named_fields.md)); supersedes 0048 | closed 2026-07-09 (0177 T5.1 status sweep) |
| 0175 | [0175_interactive_repl.md](implemented/0175_interactive_repl.md) | Implemented | have | shipped v0.0.6: interactive REPL (`src/repl/`, REPL suites in `tests/integration/test_runner_cli.rs`, [docs/internals/repl.md](../internals/repl.md)); Phase 2 engine is 0176 | closed 2026-07-09 (0177 T5.1 status sweep) |
| 0176 | [0176_interactive_repl_persistent_engine.md](implemented/0176_interactive_repl_persistent_engine.md) | Implemented | have | shipped v0.0.6: persistent-`Compiler` + live-VM incremental engine (`src/repl/engine.rs`; cross-line effects/classes/data per `changes/2026-05-29-*`, `2026-05-30-*`) | closed 2026-07-09 (0177 T5.1 status sweep) |
| 0177 | [0177_concurrency_reliability_and_actor_mvp.md](0177_concurrency_reliability_and_actor_mvp.md) | Implemented | have | committed scope M1–M5 delivered 2026-07-09: deterministic scheduler, stress harness, race audit, parity gate, `lib/Flow/Actor.flx` + `examples/actors/` + guide ch. 21 on VM+native; KI-4/5/6 fixed; T4.1 label re-scoped to value-carried capability | closed 2026-07-09; M6 (det.-scheduling follow-ups) + T4.1 label carried to 0.0.8 |
...
| 0048 | [0048_typed_record_types.md](superseded/0048_typed_record_types.md) | Superseded | [0152_named_fields_for_data_types.md](implemented/0152_named_fields_for_data_types.md) | header already flagged supersession (2026-04-18) |
